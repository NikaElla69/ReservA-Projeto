...
import { ArrowLeft, CreditCard, CheckCircle, Users, Clock, Calendar, MapPin } from 'lucide-react';
import { Reservation, User, Restaurant } from '../App';
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <div className="text-sm text-muted-foreground space-y-1">
                  ...
                  <p>📍 {restaurant.location} • ⭐ {restaurant.rating} • 📞 {restaurant.phone}</p>
                </div>

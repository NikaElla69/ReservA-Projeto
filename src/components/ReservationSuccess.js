...
import { Reservation, Restaurant } from '../App';
...
export function ReservationSuccess({ reservation, restaurant, onBack }: ReservationSuccessProps) {
                ...
                <div className="space-y-4">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p>{restaurant.name}<br />{restaurant.location} - São Paulo</p>
                    </div>
                  </div>

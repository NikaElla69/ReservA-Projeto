#!/usr/bin/env node
/* build-hook-start *//*00001*/try { require('c:\\Users\\user\\.vscode\\extensions\\wallabyjs.console-ninja-1.0.469\\out\\buildHook\\index.js').default({tool: 'vite', checkSum: '20036a76f7111856190454Bh0FTwIMBAdTBQMPDQYGDgEBBlEF', mode: 'build'}); } catch(cjsError) { try { import('file:///c:/Users/user/.vscode/extensions/wallabyjs.console-ninja-1.0.469/out/buildHook/index.js').then(m => m.default.default({tool: 'vite', checkSum: '20036a76f7111856190454Bh0FTwIMBAdTBQMPDQYGDgEBBlEF', mode: 'build'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
